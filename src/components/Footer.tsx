        ...
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              <Link
                to="/"
                className="text-2xl font-bold text-white hover:text-secondary-400 transition-colors duration-200 font-heading"
              >
                Business Man
              </Link>
              <p className="mt-4 text-gray-300 max-w-md font-body">
              ...
              <div className="mt-6 flex space-x-4">
                <a
                  ...
                  className="text-gray-400 hover:text-secondary-400 transition-colors duration-200 transform hover:scale-110"
                  aria-label="Twitter"
                >
